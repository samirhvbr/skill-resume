...
| [../.claude/README.md](../.claude/README.md) | Agent settings and permissions posture. The repository chooses no model — that is the user's `/model` choice (repodocs ADR-027). |
